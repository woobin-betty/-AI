        ...
        <div className="px-4 py-3">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">과제 관리</h1>
                <p className="text-xs text-gray-500">AI 일정 관리</p>
              </div>
            </div>
            <button 
          ...
          <div className="space-y-3">
            ...
            <div className="grid grid-cols-4 gap-2">
              ...
              <div className="bg-white rounded-lg p-3 border">
                ...
                <p className="text-[10px] text-gray-500">평균</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-3 border">
              ...
              {todayTasks.length === 0 ? (
                ...
                <div className="space-y-2">
                  {todayTasks.map(task => (
                    <div key={task.id} className="p-2.5 bg-gray-50 rounded-lg active:bg-gray-100" onClick={() => openTaskDetail(task)}>
              ...
              <div className="bg-white rounded-lg p-3 border">
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-xs text-gray-500">
                    {sortedTasks.filter(t => t.progress > 0 && t.progress < 100).length}개
                  </span>
                </div>
                <div className="space-y-2">
                  {sortedTasks.filter(t => t.progress > 0 && t.progress < 100).slice(0, 3).map(task => (
                    <div key={task.id} className="p-2.5 bg-blue-50 rounded-lg border border-blue-100 active:bg-blue-100" onClick={() => openTaskDetail(task)}>
            ...
            {sortedTasks.filter(t => t.priority === 'high').length > 0 && (
              <div className="bg-white rounded-lg p-3 border">
                <div className="flex items-center justify-between mb-2">
                  <h2 className="text-sm font-semibold flex items-center gap-1.5">
                    <AlertCircle className="w-4 h-4 text-orange-600" />마감 임박
                  </h2>
                  <span className="text-xs text-gray-500">
                    {sortedTasks.filter(t => t.priority === 'high').length}개
                  </span>
                </div>
                <div className="space-y-2">
                  {sortedTasks.filter(t => t.priority === 'high').slice(0, 3).map(task => (
                    <div key={task.id} className="p-2.5 bg-orange-50 rounded-lg border border-orange-100 active:bg-orange-100" onClick={() => openTaskDetail(task)}>
            ...
            {tasks.length === 0 && (
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg p-6 text-center border border-blue-200">
                ...
                <h3 className="text-base font-semibold text-gray-900 mb-1">첫 과제를 추가해보세요</h3>
                <p className="text-xs text-gray-600 mb-4">AI가 자동으로 일일 계획을 만들어드립니다</p>
                <button 
                  onClick={() => setShowAddModal(true)}
              ...
              todayTasks.map(task => (
                <div key={task.id} className="bg-white rounded-xl p-4 border shadow-sm">
                  ...
                  <div className="flex items-center gap-2 text-xs text-gray-600 mb-3">
                    <Clock className="w-3 h-3" />{task.todayPlan.duration} • {task.todayPlan.focus}
                  </div>
                  <div className="space-y-2">
            ...
            {sortedTasks.length === 0 ? (
              ...
              sortedTasks.map(task => (
                <div 
                  ...
                  className="bg-white rounded-xl p-4 border shadow-sm active:scale-98 transition-transform"
                >
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex-1">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-end justify-center z-50 animate-in fade-in">
          <div className="bg-white rounded-t-2xl w-full max-h-[90vh] overflow-y-auto animate-in slide-in-from-bottom">
            ...
            <div className="p-4 space-y-4">
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">과제명 *</label>
                <input
                  type="text"
                  value={newTask.title}
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">과제 설명</label>
                <textarea
              ...
              {isGenerating && (
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-sm font-medium text-blue-700">AI가 일일 계획 생성 중...</span>
                  </div>
                  <p className="text-xs text-blue-600 ml-8">잠시만 기다려주세요</p>
                </div>
              )}
